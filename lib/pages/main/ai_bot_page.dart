...
import 'package:dalmiabot/components/chat_ui/chat_bubble.dart';
import 'package:dalmiabot/main.dart';
import 'package:dalmiabot/models/message.dart';
import 'package:dalmiabot/models/order.dart';
        ...
        switch (opt) {
          ...
          case 4:
            setState(() {
              ...
              chats.add(Message(
                  message:
                      "Please enter the quantity of cement in bags(each bag is of 20kg)",
                  isUser: false,
                  date: DateTime.now()));
            });
            promptController.clear();
      ...
      case ChatState.orderPlacement:
        ...
        setState(() {
          ...
          chats.add(
            Message(
              message:
                  'Your order of $qty bag(s) of cement, totaling ₹$amt , is ready to be placed. Kindly confirm by replying with "yes" or "no".',
              isUser: false,
              date: DateTime.now(),
            ),
          );
